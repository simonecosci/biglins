    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <h1 class="mb-1 font-medium">
                        ...
                        <span
                            ...
                            class="text-xs font-normal text-[#706f6c] dark:text-[#A1A09A]"
                            >v{{ $page.props.version }}</span
                        >
                    </h1>
                ...
                <div
                    class="relative -mb-px flex aspect-[335/364] w-full shrink-0 items-center justify-center overflow-hidden rounded-t-lg bg-white lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg"
                >
                    <img
                        src="/images/logo.png"
                        alt="Logo"
                        class="w-full max-w-xs object-contain p-10"
                    />
                    <div
